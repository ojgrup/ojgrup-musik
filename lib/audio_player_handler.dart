...
import 'data_model.dart'; // Menggunakan file yang sudah kita buat
...
class AudioPlayerHandler extends BaseAudioHandler with QueueHandler {
  ...
  AudioPlayerHandler() {
    // Constructor harus ringan, hanya panggil listener
    _listenForPlayerStateChanges();
    _listenForSequenceStateChanges();
  }
  
  // SOLUSI CRASH RUNTIME: Semua inisialisasi async ada di sini
  @override
